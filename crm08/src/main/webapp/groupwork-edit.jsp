        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="role-table" class="waves-effect"><i class="fa fa-modx fa-fw" aria-hidden="true"></i><span class="hide-menu">Quyền</span></a>
                    </li>
                    <li>
                        <a href="groupwork" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i><span class="hide-menu">Dự án</span></a>
                    </li>
                    <li>
                        <a href="task" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i><span class="hide-menu">Công việc</span></a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <!-- Sửa action của form -->
                            <form class="form-horizontal form-material" action="groupwork-edit" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="name" placeholder="Tên dự án"
                                            class="form-control form-control-line" value="${project.name}" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="startDate" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" value="${project.startDate}" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="endDate" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"  value="${project.endDate}"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
