...
<head>
    ...
    <title>Pixel Admin - Chỉnh sửa thành viên</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="user-edit" method="post" class="form-horizontal form-material">
                                <input type="hidden" name="id" value="${user.id}">
                                <div class="form-group">
                                    <label class="col-md-12">Họ và tên</label>
                                    <div class="col-md-12">
                                        <input name="fullname" type="text" placeholder="Họ và tên"
                                            class="form-control form-control-line" value="${user.fullname}">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="phone" type="text" placeholder="+84 123 456"
