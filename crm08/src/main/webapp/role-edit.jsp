                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="role-edit" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="name" placeholder="Tên quyền"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="description" placeholder="Mô tả" class="form-control form-control-line" value="${role.description}" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
