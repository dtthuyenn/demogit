            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="task-edit" method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="startDate" name="startDate" value="${task.startDate}"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="endDate" name="endDate" value="${task.endDate}"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name="userId" class="form-control form-control-line">
                                            <c:forEach var="user" items="${userList}">
                                                <option value="${user.id}" ${user.id == task.userId ? 'selected' : ''}>${user.fullname}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
